...
urlpatterns = [
    ...
    path(
        "publish/moto/", AddMoto.as_view(), name="publish_moto"
    ),  # AuthorizedPermission
    # edit model
    path(
        "car/edit/<slug:slug>/", CarEditView.as_view(), name="edit_car"
    ),  # ModerPermission
    path(
        "motos/edit/<slug:slug>/", MotoEditView.as_view(), name="edit_moto"
    ),  # ModerPermission
    # delete models
    path(
        "car/delete/<slug:slug>/", CarDeleteView.as_view(), name="delete_car"
    ),  # ModerPermission
    path(
        "motocycle/delete/<slug:slug>/", MotoDeleteView.as_view(), name="delete_moto"
    ),  # ModerPermission
]
