...
urlpatterns = [
    ...
    path('motorcycle/delete/<slug:slug>/', MotoDeleteView.as_view(), name='delete_motorcycle'),
    path('service/delete/<slug:slug>/', ServiceDeleteView.as_view(), name='delete_service'),
