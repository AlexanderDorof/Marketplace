    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guarantee', models.DateField(blank=True, default=datetime.datetime(2024, 2, 19, 3, 27, 16, 885579, tzinfo=datetime.timezone.utc), verbose_name='Гарантийный срок')),
                ('engine_type', models.CharField(choices=[('Electricity', 'Электромобиль'), ('Oil', 'ДВС')], default='ДВС', help_text='ДВС или электрокар', max_length=15, verbose_name='Тип двигателя')),
                ...
                ('color', models.CharField(blank=True, choices=[('red', 'Red'), ('blue', 'Blue'), ('green', 'Green'), ('yellow', 'Yellow'), ('orange', 'Orange'), ('purple', 'Purple'), ('pink', 'Pink'), ('brown', 'Brown'), ('gray', 'Gray'), ('teal', 'Teal')], default='Red', help_text='В соответствии с техпаспортом', max_length=15, verbose_name='Цвет')),
                ...
                ('body_type', models.CharField(choices=[('Sedan', 'Sedan'), ('Hatchback', 'Hatchback'), ('Pickup', 'Pickup')], default='Sedan', help_text='В соответствии с техпаспортом', max_length=15, verbose_name='Тип кузова')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guarantee', models.DateField(blank=True, default=datetime.datetime(2024, 2, 19, 3, 27, 16, 887578, tzinfo=datetime.timezone.utc), verbose_name='Гарантийный срок')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=150, unique=True, verbose_name='URL slug')),
                ('description', models.TextField(blank=True, default='no description', help_text='Для чего предназначено, опишите плюсы и минусы', verbose_name='Описание')),
                ('guarantee', models.DateField(blank=True, default=datetime.datetime(2024, 2, 19, 3, 27, 16, 886581, tzinfo=datetime.timezone.utc), verbose_name='Гарантийный срок')),
                ('price', models.DecimalField(decimal_places=2, default=9.99, help_text='В долларах ($)', max_digits=5, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Цена')),
