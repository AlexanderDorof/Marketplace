...
class AddCarForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "description": Textarea(
                attrs={"class": "form-control", "cols": 4, "rows": 3}
            ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.instance.seller = self.initial.get(
            "seller"
        )  # adds user who created record in db as seller
        self.instance.used_car = self.initial.get(
            "used_car"
        )  # marks that car/moto is uses
